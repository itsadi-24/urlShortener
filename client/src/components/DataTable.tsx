...
//         <tr
//           key={item._id}
//           className='text-white bg-gray-600 border-b hover:bg-white hover:text-gray-800'
//         >
...
//           <thead className='uppercase bg-gray-700 text-md text-gray-50'>
//             <tr>
...
export function DataTable() {
  return (
    <Table>
      <TableCaption>A list of your URL's.</TableCaption>
      <TableHeader>
        <TableRow>
